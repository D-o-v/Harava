    ...
    <div>
      ...
      <div className="p-6 space-y-6">
        <div className="grid grid-cols-4 gap-4">
          <Card><CardContent className="p-4 flex items-center gap-3"><Shield className="w-8 h-8 text-emerald-500" /><div><p className="text-xl font-bold">Strong</p><p className="text-xs text-gray-500">Security Posture</p></div></CardContent></Card>
          ...
          <Card><CardContent className="p-4 flex items-center gap-3"><Eye className="w-8 h-8 text-blue-500" /><div><p className="text-xl font-bold">24/7</p><p className="text-xs text-gray-500">Monitoring</p></div></CardContent></Card>
        </div>
            ...
            {events.map((e) => (
              <div key={e.id} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50">
                <div className="flex items-center gap-3">
                  {e.resolved ? <CheckCircle className="w-5 h-5 text-emerald-500" /> : <AlertTriangle className="w-5 h-5 text-amber-500" />}
                  <div>
